...
if __name__ == "__main__":
    # 项目跟路径:
    dir_root = r'D:\python_bs\Code\Apple_Grading_Detection'
    # 训练好的模型路径
    model_path = r'logs\loss_43557801925\last_epoch_weights.pth'
    map_mode        = 0
    ...
    if map_mode == 0 or map_mode == 1:
        print("Load model.")
        frcnn = FRCNN(confidence = confidence, nms_iou = nms_iou, model_path=model_path, classes_path=classes_path, anchors_size=anchors_size)
